...
export const APPARATUS: ApparatusItem[] = [
  ...
  // ---- additions so every experiment in the 115-item catalogue has its full kit ----
  { id: "iron-nail", name: "Iron Nail / Key (test specimen)", category: "Hand Tools", shape: "rod",
    width: 14, height: 90, mass: 12, friction: 0.7, restitution: 0.05, color: DARK, fill: METAL,
    usage: "Specimen for rusting investigations and the cathode when electroplating with copper or zinc." },
  { id: "metal-strips", name: "Metal Strips Set (Mg, Zn, Fe, Cu)", category: "Electrochemistry & Analysis", shape: "electrode",
    width: 26, height: 110, mass: 25, friction: 0.6, restitution: 0.08, color: DARK, fill: METAL,
    usage: "Half-cell electrodes and displacement-reaction specimens for building the reactivity series.",
    hazards: "Clean with sandpaper before use; magnesium is flammable." },
  { id: "lead-plate", name: "Lead Plate Pair", category: "Electrochemistry & Analysis", shape: "electrode",
    width: 30, height: 115, mass: 220, friction: 0.6, restitution: 0.05, color: DARK, fill: "#9AA0A6",
    usage: "Electrodes for charging and discharging a simple lead–acid accumulator.",
    hazards: "Lead is toxic — wear gloves and wash hands afterwards." },
  { id: "petri-agar", name: "Petri Dish with Agar Jelly", category: "Containers & Vessels", shape: "petri-dish",
    width: 110, height: 34, mass: 130, friction: 0.7, restitution: 0.03, color: INK, fill: "#D9E9C9",
    usage: "Agar medium set with indicator so ion migration during rusting or electrolysis can be seen." },
  { id: "sample-bulb", name: "Sealed Glass Sample Bulb", category: "Distillation & Specialised", shape: "bulb",
    width: 46, height: 70, mass: 18, friction: 0.4, restitution: 0.1, color: INK, fill: WHITE,
    usage: "Holds a weighed sample of volatile liquid for the Victor Meyer determination of Mr." },
  { id: "sealed-tube", name: "Sealed Ground-Glass Tube", category: "Distillation & Specialised", shape: "test-tube",
    width: 30, height: 130, mass: 40, friction: 0.5, restitution: 0.06, color: INK, fill: "#C79A6B",
    usage: "Closed system holding an equilibrium gas mixture (e.g. NO₂ / N₂O₄) for temperature studies.",
    hazards: "Never heat above 80 °C — the sealed tube can burst." },
  { id: "dark-chamber", name: "Dark Room Chamber", category: "Measuring Instruments", shape: "shield",
    width: 140, height: 110, mass: 900, friction: 0.8, restitution: 0.02, color: DARK, fill: "#2A2F3A",
    usage: "Blacked-out enclosure so a light beam through a colloid (Tyndall effect) is visible." },
  { id: "drying-oven", name: "Drying Oven / Hot-Air Dryer", category: "Heating Equipment", shape: "calorimeter",
    width: 120, height: 100, mass: 4000, friction: 0.8, restitution: 0.02, color: METAL, fill: AMBER,
    usage: "Drying precipitates and developing sprayed chromatograms at a controlled temperature.",
    hazards: "Hot surfaces — use tongs." },
  { id: "spray-bottle", name: "Locating-Agent Spray Bottle", category: "Hand Tools", shape: "bottle",
    width: 52, height: 100, mass: 90, friction: 0.6, restitution: 0.05, color: INK, fill: PURPLE,
    usage: "Applies ninhydrin or other locating agents to a developed chromatogram.",
    hazards: "Spray in a fume cupboard only." },
  { id: "kipps-generator", name: "Kipp's Gas Generator", category: "Gas Handling & Collection", shape: "column",
    width: 90, height: 170, mass: 1400, friction: 0.6, restitution: 0.02, color: INK, fill: TEAL,
    usage: "On-demand generation of CO₂, H₂ or H₂S from a solid and an acid.",
    hazards: "Use in a fume cupboard for H₂S." },
  { id: "candle", name: "Candle", category: "Heating Equipment", shape: "spirit-lamp",
    width: 34, height: 90, mass: 60, friction: 0.7, restitution: 0.05, color: AMBER, fill: "#F3E4C0",
    usage: "Small luminous flame for combustion, soot and gas-test demonstrations.",
    hazards: "Naked flame — keep away from flammable solvents." },
  { id: "dichromate-paper", name: "Acidified K₂Cr₂O₇ Test Paper", category: "Gas Handling & Collection", shape: "paper",
    width: 40, height: 90, mass: 2, friction: 0.6, restitution: 0.05, color: INK, fill: "#E8A33D",
    usage: "Turns orange to green in sulfur dioxide — confirmatory test for SO₂." },
  { id: "lead-acetate-paper", name: "Lead Acetate Test Paper", category: "Gas Handling & Collection", shape: "paper",
    width: 40, height: 90, mass: 2, friction: 0.6, restitution: 0.05, color: INK, fill: "#F2F0E6",
    usage: "Blackens in hydrogen sulfide — confirmatory test for H₂S.",
    hazards: "Lead salts are toxic." },
  { id: "cross-card", name: "Paper Marked with a Cross", category: "Hand Tools", shape: "paper",
    width: 80, height: 80, mass: 3, friction: 0.6, restitution: 0.05, color: DARK, fill: WHITE,
    usage: "Placed under a conical flask; the cross disappearing times a precipitation rate experiment." },
  { id: "desiccant-tube", name: "Calcium Chloride / Soda-Lime Guard Tube", category: "Gas Handling & Collection", shape: "tubing",
    width: 40, height: 120, mass: 90, friction: 0.6, restitution: 0.04, color: INK, fill: "#E4E0D3",
    usage: "Absorbs water vapour (CaCl₂) or carbon dioxide (soda lime) so combustion products can be weighed." },
];
